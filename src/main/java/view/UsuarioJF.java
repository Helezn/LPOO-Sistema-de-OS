...
public class UsuarioJF extends javax.swing.JFrame {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        Usuario usuSelecionado = lstUsuarios.getSelectedValue();
        if (usuSelecionado != null) {
            CadastroUsuarioJD telaCadastro = new CadastroUsuarioJD(this, true);
            telaCadastro.setUsuario(usuSelecionado);
            telaCadastro.setVisible(true);
            loadUsuario();
        } else {
